    ...
    try {
      ...
      if (data.success) {
        if (data.duplicateDetected) {
          ...
          setFormMsg({
            type: 'success',
            text: 'Deal added successfully and scheduled for processing!',
          });
        }
      ...
      >
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)' }}>
            Automated E-commerce to WhatsApp Posting Core
          </p>
        </div>
        ...
        <div
          ...
          style={{ padding: '12px 20px', display: 'flex', alignItems: 'center', gap: '16px' }}
        >
          <div>
              ...
              <span
                className={`status-dot ${
                  settings.whatsappStatus === 'CONNECTED'
                    ? 'online'
                    : settings.whatsappStatus === 'INITIALIZING'
                      ? 'initializing'
                      : 'offline'
                }`}
              />
          ...
          {settings.whatsappStatus !== 'CONNECTED' && settings.whatsappQrCode && (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              />
              <span style={{ fontSize: '9px', marginTop: '2px', color: 'var(--color-secondary)' }}>
                Scan QR
              </span>
            </div>
          )}
                          ...
                          <tr key={deal.id}>
                            ...
                            <td>
                              {deal.scheduledTime ? (
                                ...
                                >
                                  <Clock size={12} />
                                  {new Date(deal.scheduledTime).toLocaleTimeString([], {
                                    hour: '2-digit',
                                    minute: '2-digit',
                                  })}
                                </span>
                            ...
                            <td>
                              <div style={{ display: 'flex', gap: '8px' }}>
                                ...
                                {deal.wishlinkUrl && (
                                  <a
                                    href={deal.wishlinkUrl}
                                    target="_blank"
                                    rel="noreferrer"
                                    title="Wishlink Affiliate"
            ...
            <div className="glass-panel">
              ...
              {deals.filter(d => d.status === 'DUPLICATE_PENDING').length === 0 ? (
                ...
                >
                  <CheckCircle2
                    size={40}
                    style={{ color: 'var(--color-success)', marginBottom: '12px' }}
                  />
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  {deals
                    .filter(d => d.status === 'DUPLICATE_PENDING')
                    .map(deal => (
                      <div
                        key={deal.id}
                        className="glass-panel"
                      ...
                      >
                        <div>
                          ...
                          >
                            Normalized URL:{' '}
                            <code style={{ color: 'var(--color-secondary)' }}>
                              {deal.normalizedUrl}
                            </code>
                          </p>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                      <div>
                        ...
                        <input
                          ...
                          onChange={e =>
                            setSettings({ ...settings, wishlinkUrlInput: e.target.value })
                          }
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={e =>
                            setSettings({ ...settings, wishlinkGenerateBtn: e.target.value })
                          }
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={e =>
                            setSettings({ ...settings, wishlinkShortlinkText: e.target.value })
                          }
                        />
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={e =>
                          setSettings({ ...settings, duplicateCheckDays: e.target.value })
                        }
                      />
                    </div>
                  </div>
                  ...
                  {settings.whatsappStatus === 'CONNECTED' ? (
                    <div style={{ padding: '20px 0' }}>
                      ...
                      <p style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>
                        WhatsApp client is running in background successfully.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        Scan this QR code from linked devices on your WhatsApp mobile application to
                        connect.
                      </p>
                      <div
                        style={{
                    ...
                    <div style={{ padding: '40px 0', color: 'var(--text-secondary)' }}>
                      ...
                      <p style={{ fontSize: '12px' }}>
                        Generating QR Code or starting WhatsApp service...
                      </p>
                    </div>
                  )}
                </div>
